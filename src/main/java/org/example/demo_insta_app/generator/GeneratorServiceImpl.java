...
public class GeneratorServiceImpl {
    ...
    public byte[] createPdf(TestUser user) {
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            twoT2.addCell("").setFontSize(12).setBorder(Border.NO_BORDER);
            twoT2.addCell("Account number   " + user.getAccountNumber() + "\nRouting number   " + user.getRoutingNumber())
            ...
            twoT5.addCell("Po Box " + po_box + "\nAshford,Al 36574" + "\nEmail:" + user.getEmail() + "\nPhone:" + user.getPhoneNumber()).setFontSize(12).setBorder(Border.NO_BORDER);
